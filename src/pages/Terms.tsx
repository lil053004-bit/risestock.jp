        ...
        <div className="bg-white rounded-xl shadow-card-shadow p-8">
          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                当サービスは、AI技術を活用して公開されている株式市場の情報を分析し、参考情報として利用者に提供する情報提供サービスです。
              </p>
              <p className="text-gray-700 leading-relaxed mb-3">
                当サービスは以下の機能を提供します：
              </p>
            ...
            <section className="mb-8">
              ...
              <div className="bg-red-50 border-l-4 border-red-500 p-4 mb-4">
                ...
                <div className="space-y-2 text-gray-700 leading-relaxed">
                  <p>
                    <strong>【情報提供サービス】</strong><br />
                    当サービスは情報提供のみを目的としており、投資助言業務、投資一任業務、金融商品仲介業務には該当しません。特定の金融商品の売買を推奨・勧誘するものではありません。
                  </p>
                  <p>
                    <strong>【投資リスク】</strong><br />
                    株式投資には価格変動リスク、信用リスク、流動性リスク等が伴い、投資元本を失う可能性があります。過去の分析結果や運用実績は将来の運用成果を保証するものではありません。
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    当社は金融商品取引業者（投資助言・代理業、投資運用業等）ではありません。金融商品取引法第29条の登録を受けた事業者ではないため、個別の投資助言を行うことはできません。
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                当サービスのAI分析は、公開されている過去の市場データおよび財務情報に基づくものであり、以下の限界があります：
              </p>
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                <li>将来の市場状況や株価を予測・保証するものではありません</li>
