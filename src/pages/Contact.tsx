        ...
        <div className="bg-white rounded-xl shadow-card-shadow p-8">
          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="bg-red-50 border-l-4 border-red-500 p-4">
                ...
                <div className="text-red-800 leading-relaxed space-y-2">
                  <p>
                    当サービスは金融商品取引業者（投資助言・代理業、投資運用業等）ではないため、個別の投資助言を行うことはできません。
                  </p>
                  <p>
                    本サービスは情報提供のみを目的としており、特定の金融商品の売買を推奨・勧誘するものではありません。
                  </p>
                  <p>
            ...
            <div className="bg-slate-100 rounded-lg p-6">
              ...
              <p className="text-sm text-gray-700 mb-2">
                <strong>会社名:</strong> 株式会社マーケットインサイト (Market Insight Co., Ltd.)
              </p>
              <p className="text-sm text-gray-700 mb-2">
                <strong>郵便番号:</strong> 〒103-0027
              </p>
              <p className="text-sm text-gray-700 mb-2">
                <strong>所在地:</strong> 〒103-0027 東京都中央区日本橋3-14-5 日本橋テラスビル6F
              </p>
              <p className="text-sm text-gray-700 mb-2">
