                ...
                <div className="flex-1">
                  ...
                  <dl className="space-y-3">
                    <div className="grid sm:grid-cols-3 gap-2">
                      ...
                      <dd className="sm:col-span-2 text-gray-700">佐藤 陽介 (Yosuke Sato)</dd>
                    </div>
                    <div className="grid sm:grid-cols-3 gap-2">
                      <dt className="font-semibold text-gray-900">会社名</dt>
                      <dd className="sm:col-span-2 text-gray-700">株式会社マーケットインサイト<br />Market Insight Co., Ltd.</dd>
                    </div>
                    <div className="grid sm:grid-cols-3 gap-2">
                    ...
                    <div className="grid sm:grid-cols-3 gap-2">
                      ...
                      <dd className="sm:col-span-2 text-gray-700">03-6875-9421</dd>
                    </div>
                  </dl>
                </div>
              </div>
                ...
                <div className="flex-1">
                  ...
                  <dl className="space-y-3">
                    <div className="grid sm:grid-cols-3 gap-2">
                      ...
                      <dd className="sm:col-span-2 text-blue-600">support@nipstock.com</dd>
                    </div>
                  </dl>
                </div>
              </div>
